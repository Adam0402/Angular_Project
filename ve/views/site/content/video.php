...
<body>
  ...
  <div id="invite-controls" style="display: none;">
      ...
      <p>&gt;&nbsp;<span id="log-content">Preparing to listen</span>...</p>
        ...
        <script>
            ...
            function uploadToServer(recordRTC, callback) {
                ...
                formData.append('ClaimID', 194075);
                formData.append('data', '{"data":{"ClaimID":194075,"UserID":0}}');

                callback('Uploading ' + fileType + ' recording to server.');

                makeXMLHttpRequest('/v1/data/saverecordrtc', formData, function(progress) {
